...
- client_type leader，random，no_leader，默认random。leader仅从主数据节点查询，random: 从ps主从节点随机选择，no_leader:只查询从节点。
  设置方式： http://router_server/$db_name/$space_name/_search?client_type=leader
